...
$reqCompagnie = $conn->conbdd()->query("SELECT nom FROM compagnie");
                        ...
                        <div class="col-lg-7 col-xl-8">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Vue des Revenues de <?=$ans?></h6>
                        ...
                        <div class="col-lg-5 col-xl-4">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    if (array_key_exists("mois", $_GET)) {
                                    ?>
                                    <h6 class="text-primary fw-bold m-0">Sources de Revenues Mensuelles</h6>
                                    <?php
                                    } else {
                                    ?>
                                    <h6 class="text-primary fw-bold m-0">Sources de Revenues Annuelles</h6>
                                    <?php
                                    }
                                    ?>
                                    <div class="dropdown no-arrow"><button class="btn btn-link btn-sm dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" type="button"><i class="fas fa-ellipsis-v text-gray-400"></i></button>
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="text-primary fw-bold m-0">Compagnie</h6>
                                </div>
                                <div class="card-body">
                                    <?php
                                    foreach ($resCompagnie as $compagnie) {
                                    ?>
                                        <h4 class="small fw-bold"><?=$compagnie["nom"]?><span class="float-end">100%</span></h4>
                                        <div class="progress mb-4">
                                            <div class="progress-bar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: <?= 100 ?>%; background-color: #ffe0d2;"><span class="visually-hidden">100%</span></div>
                                        </div>
                                    <?php
                                    }
                                    ?>
