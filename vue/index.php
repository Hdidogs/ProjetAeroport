...
<div class="content">
    <div class="offer">
        <div style="width: 100%; height: 500px; left: 0; top: 89px; background: #D9D9D9"></div>
        <button style="width: 161px; height: 42px; right: 10%; top: 400px; position: absolute; background: white; box-shadow: 0 4px 4px rgba(0, 0, 0, 0.25); border-radius: 25px; border: none;">Partir Maintenant</button>
    </div>

    <div class="help">
        <div style="width: 90%; height: 402px; left: 5%; top: 600px; position: absolute; background: #D1D1D1; box-shadow: 0 4px 4px rgba(0, 0, 0, 0.25); border-radius: 38px">
            ...
            <div style="width: 15%; height:15%; left: 10%; top: 30%; position: absolute; background: #333333; box-shadow: 0 4px 4px rgba(0, 0, 0, 0.25); border-radius: 38px"></div>
...
<header class="headerBar" style="left: 0; top: 0">
    ...
    <!-- USER -->
    <div style="width: 67px; height: 67px; right: 4%; top: 17px; background: #D9D9D9; position: absolute; border-radius: 9999px"></div>

    <!-- LOGO -->
    <div style="width: 77px; height: 77px; left: 1%; top: 12px; position: absolute; background: #D9D9D9; border-radius: 9999px"></div>

    <!-- Search -->
    <div style="width: 29px; height: 29px; right: 10%; top: 36px; background: #D9D9D9; position: absolute; border-radius: 9999px"></div>
</header>
</body>
</html>