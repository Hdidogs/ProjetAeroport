                ...
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card mb-5" style="box-shadow: 0 4px 4px rgba(0, 0, 0, 0.25);border-bottom-left-radius: 25px;border-bottom-right-radius: 25px;border-top-left-radius: 25px;border-top-right-radius: 25px;">
                        <div class="card-body p-sm-5">
                            <h2 class="text-center mb-4"><i class="fa-solid fa-plane"></i> Réserver</h2>
                            <form method="post">
                    ...
                    <li class="nav-item">
                        <div class="dropdown" style="margin-top: -5px">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light text-small" style="box-shadow: 0 4px 4px rgba(0, 0, 0, 0.25);border-bottom-left-radius: 15px;border-bottom-right-radius: 15px;border-top-left-radius: 15px;border-top-right-radius: 15px;border: none;">
                                ...
                                <li><a class="dropdown-item" href="en/index.php"><svg class="svg-snoweb svg-theme-light" height="50" preserveaspectratio="xMidYMid meet" viewbox="0 0 100 100" width="50" x="0" xmlns="http://www.w3.org/2000/svg" y="0">
