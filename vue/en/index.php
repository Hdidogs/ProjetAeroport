    ...
    <div class="content">
        ...
        <div id="services" class="card-group" style="margin: 15px;">
            ...
            <div class="card scale"
                style="box-shadow: 0 4px 4px rgba(0, 0, 0, 0.25);border-bottom-left-radius: 25px;border-bottom-right-radius: 25px;border-top-left-radius: 25px;border-top-right-radius: 25px; margin: 10px;">
                <div class="card-body">
                    <h4 class="card-title">Feeling Hungry?</h4>
                    <p class="card-text">Explore our various restaurants located within our airport. From fast food to the luxurious meals of a 5-star restaurant, you'll find everything you need to satisfy your hunger.</p>
                </div>
                <div style="margin: 20px">
            ...
            <div class="card scale"
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Discover our diverse and captivating shops! Carefully selected range of renowned brands for a unique shopping experience. Exceptional customer service, each visit is an adventure!</p>
                </div>
                <div style="margin: 20px">
                    <button class="btn" style="background-color: #ffe0d2; color: #333333" type="button">Check Out</button>
                </div>
            </div>
            <div class="card scale"
                style="box-shadow: 0 4px 4px rgba(0, 0, 0, 0.25);border-bottom-left-radius: 25px;border-bottom-right-radius: 25px;border-top-left-radius: 25px;border-top-right-radius: 25px; margin: 10px;">
        ...
        <section id="reservation" class="position-relative py-4 py-xl-5" style="background: var(--bs-body-bg); ">
            <div class="container position-relative">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="text fw-bold m-0" style="color: black;">Flight Reservation</h6>
                    </div>
                    <div class="content-card">
                        <form action="flight/flightsResult.php" method="get">
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        <th><label class="text-form" for="type">Type of Trip</label></th>
                            ...
                            <table>
                                <thead>
                                <tr>
                                    <th><label class="text-form" for="departure_date">Departure Date</label></th>
                                    <th><label class="text-form" for="return_date">Return Date</label></th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <td><input type="date" name="departure_date" id="departure_date" required></td>
                                    <td><input type="date" name="return_date" id="return_date" required></td>
                                </tr>
                                </tbody>
                            </table>
                            <br>
                            <table>
                                <thead>
                                <tr>
                                    <th><label class="text-form" for="departure">Departure</label></th>
                                    <th><label class="text-form" for="destination">Destination</label></th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <td><select id="departure" name="departure" required>
                                            <?php
                            ...
                            <br>
                            <br>
                            <button class="btn" style="background-color: #ffe0d2; color: #333333;" name="search" type="submit">Search</button>
                            <br>
                            <br>
                        </form>
                    </div>
